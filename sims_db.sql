...
--
-- Name: item_master; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.item_master (
    id bigint NOT NULL,
    vchr_item_code character varying(20) NOT NULL,
    vchr_item_name character varying(100) NOT NULL,
    txt_description text,
    dbl_price numeric(10,2) NOT NULL,
    int_quantity integer NOT NULL,
    dat_created timestamp with time zone NOT NULL,
    dat_updated timestamp with time zone,
    bln_active boolean NOT NULL,
    fk_created_id integer NOT NULL
);


ALTER TABLE public.item_master OWNER TO admin;

--
-- Name: item_master_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--
...
25	Can add Item Master	7	add_itemmaster
26	Can change Item Master	7	change_itemmaster
27	Can delete Item Master	7	delete_itemmaster
28	Can view Item Master	7	view_itemmaster
\.
...
1	contenttypes	0001_initial	2024-10-08 22:11:03.185096+05:30
2	auth	0001_initial	2024-10-08 22:11:03.249711+05:30
3	admin	0001_initial	2024-10-08 22:11:03.271232+05:30
4	admin	0002_logentry_remove_auto_add	2024-10-08 22:11:03.279977+05:30
5	admin	0003_logentry_add_action_flag_choices	2024-10-08 22:11:03.291342+05:30
6	contenttypes	0002_remove_content_type_name	2024-10-08 22:11:03.307106+05:30
7	auth	0002_alter_permission_name_max_length	2024-10-08 22:11:03.318035+05:30
8	auth	0003_alter_user_email_max_length	2024-10-08 22:11:03.327199+05:30
9	auth	0004_alter_user_username_opts	2024-10-08 22:11:03.335766+05:30
10	auth	0005_alter_user_last_login_null	2024-10-08 22:11:03.346579+05:30
11	auth	0006_require_contenttypes_0002	2024-10-08 22:11:03.349401+05:30
12	auth	0007_alter_validators_add_error_messages	2024-10-08 22:11:03.35844+05:30
13	auth	0008_alter_user_username_max_length	2024-10-08 22:11:03.371513+05:30
14	auth	0009_alter_user_last_name_max_length	2024-10-08 22:11:03.381266+05:30
15	auth	0010_alter_group_name_max_length	2024-10-08 22:11:03.392652+05:30
16	auth	0011_update_proxy_permissions	2024-10-08 22:11:03.40066+05:30
17	auth	0012_alter_user_first_name_max_length	2024-10-08 22:11:03.410381+05:30
18	crud	0001_initial	2024-10-08 22:11:03.432053+05:30
19	sessions	0001_initial	2024-10-08 22:11:03.444937+05:30
\.
...
--
-- Data for Name: item_master; Type: TABLE DATA; Schema: public; Owner: admin
--
...
--
-- Name: item_master item_master_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: item_master item_master_vchr_item_code_key; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.item_master
    ADD CONSTRAINT item_master_vchr_item_code_key UNIQUE (vchr_item_code);
...
--
-- Name: item_master_fk_created_id_b170f8d9; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX item_master_fk_created_id_b170f8d9 ON public.item_master USING btree (fk_created_id);


--
-- Name: item_master_vchr_item_code_e70bd795_like; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX item_master_vchr_item_code_e70bd795_like ON public.item_master USING btree (vchr_item_code varchar_pattern_ops);
...
--
-- Name: item_master item_master_fk_created_id_b170f8d9_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.item_master
    ADD CONSTRAINT item_master_fk_created_id_b170f8d9_fk_auth_user_id FOREIGN KEY (fk_created_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;
